...
#ifndef PROCESSING_DELAY_SENDER_H
#define PROCESSING_DELAY_SENDER_H
...
/**
 * \sends probe packets to ProcessingDelayReceiver and analyzes the results it recieves
 */
class ProcessingDelaySender : public Application
{
public:
  static TypeId GetTypeId (void);
  ProcessingDelaySender ();
  virtual ~ProcessingDelaySender ();
...
//
  ...
  // Address of ProcessingDelayReceiver
...
#endif /* PROCESSING_DELAY_SENDER_H */
