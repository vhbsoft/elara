...
namespace ns3 {
//
// PriorityQueueModelHelper functions
//
PriorityQueueModelHelper::PriorityQueueModelHelper ()
{
  m_factory.SetTypeId (PriorityQueueModel::GetTypeId());
}

void
PriorityQueueModelHelper::SetAttribute (std::string name, const AttributeValue &value)
{
