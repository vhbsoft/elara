 ...
 * Robert Chang 2012
 * Usage:
> ./waf --run "4-node-traffic-shaper --outputFile=./test.dat --numPackets=1000  --packetSize=1024 --interPacketTime=.0000001 --s0p0Delay=30ms --p0p1Delay=30ms --p1r0Delay=30ms --s0p0DataRate=5Mbps --p0p1DataRate=4Mbps --p1r0DataRate=5Mbps --queueMode=b --s0QueueSize=655350000 --p0QueueSize=655350000 --p1QueueSize=655350000"
...
//
  ...
  if (queueMode == 'p') {
    ...
    NS_LOG_UNCOND("Invalid queueMode!");
    exit(1);
  }
...
//
  ...
  sendHelper.GetSender()->SetEntropy('l');
