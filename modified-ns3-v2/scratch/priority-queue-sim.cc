 ...
 *
 * Usage:
./waf --run "priority-queue-sim --TXQueueSizeR2=100 --TXQueueSizeS=4000000 --highPriorityQueueSize=5 --lowPriorityQueueSize=5 --SR1Delay=5ms --R1R2Delay=5ms --R2RDelay=5ms --SR1DataRate=25Mbps --R1R2DataRate=10Mbps --R2RDataRate=100Mbps --outputFile=./OUTPUT_FILES/P_L_L_10.dat --packetSize=1024 --interPacketTime=0.00000001 --initialPacketTrainLength=1000 --separationPacketTrainLength=10 --numAptPriorityProbes=1000 --aptPriority='L'"
 */
